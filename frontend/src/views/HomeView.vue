...
<template>
  <main class="page">
    <section class="hero">
      <div class="hero-copy">
        <div class="badge">Sensory-Friendly Cooking</div>
        <h1 class="h1">
          Your Kitchen,<br />
          <span class="h1-sub">Quietly Reimagined.</span>
        </h1>
        <p class="lead">
...
.media-overlay {
  position: absolute;
  inset: 0;
  background: radial-gradient(circle at 30% 30%, rgba(68, 98, 113, 0.08), transparent 60%);
  pointer-events: none;
}
